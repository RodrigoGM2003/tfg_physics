...
namespace test{
    ...
    TestComplex::TestComplex()
        ...
        glm::vec3 position = glm::vec3(-60.0f, 0.0f, 0.0f);
        ...
        properties[m_model_matrices->size() - 2].angular_velocity= glm::linearRand(glm::vec3(-0.3f), glm::vec3(0.3f));
    ...
    void TestComplex::onUpdate(float delta_time){ 
    ...
    void TestComplex::onImGuiRender(){
