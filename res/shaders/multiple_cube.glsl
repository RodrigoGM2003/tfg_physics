...
layout(location = 3) in vec4 instance_matrix_1;
layout(location = 4) in vec4 instance_matrix_2;
layout(location = 5) in vec4 instance_matrix_3;
layout(location = 6) in vec4 instance_matrix_4;
